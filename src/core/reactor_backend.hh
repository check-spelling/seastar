...
class aio_storage_context {
    ...
    pending_aio_retry_t _pending_aio_retry; // Pending rentries iocbs
    pending_aio_retry_t _aio_rentries;       // Currently retried iocbs
    ...
    bool need_to_retry() const noexcept {
        return !_pending_aio_retry.empty() || !_aio_rentries.empty();
    }
